import WelcomeImage from "@/app/asset/img/welcome.png";
      ...
      <div className="flex items-center justify-between sm:justify-center gap-x-6 rounded-t-sm border bg-popover pl-2 pr-1 py-1 relative">
        ...
        <div className="sm:mx-auto w-full max-w-60 rounded-sm bg-background py-1 text-center">
          <p className="text-xs font-light text-foreground">
            localhost<span className="text-muted-foreground">:3000</span>
          </p>
        </div>
      </div>
      <div className="rounded-b-sm bg-background p-0 border border-t-0 flex items-center justify-center aspect-video">
        <img src={WelcomeImage.src} alt="Welcome" className="w-full" />
      </div>
    </div>
  );
};
